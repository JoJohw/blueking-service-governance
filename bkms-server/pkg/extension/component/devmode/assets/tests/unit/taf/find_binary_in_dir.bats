...
@test "taf find_binary_in_dir returns the binary when its name exactly matches app name" {
...
@test "taf find_binary_in_dir matches the binary when only letter case differs" {
...
@test "taf find_binary_in_dir matches the binary when app name uses hyphens but binary in different form" {
...
@test "taf find_binary_in_dir matches the binary when it uses mixed case without separators" {
...
@test "taf find_binary_in_dir matches the binary when hyphens and underscores differ" {
...
@test "taf find_binary_in_dir strips the executable marker emitted by ls output" {
...
@test "taf find_binary_in_dir returns empty output when the directory has no matching binary" {
...
@test "taf find_binary_in_dir returns empty output when only a dotted name exists" {
...
@test "taf find_binary_in_dir returns empty output when only a longer prefixed name exists" {
...
@test "taf find_binary_in_dir returns empty output when the search directory does not exist" {
